...
ALTER TABLE "auth_identities" DROP CONSTRAINT "auth_identities_user_id_user_id_fk";--> statement-breakpoint
...
ALTER TABLE "auth_identities" ALTER COLUMN "user_id" SET DATA TYPE uuid USING "user_id"::uuid;--> statement-breakpoint
