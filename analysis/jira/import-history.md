...
| Implemented/in progress | In Progress | Created story issues `KAN-24`, `KAN-26`, `KAN-56`, and `KAN-57`; `KAN-29` pending transition. | These stories include committed behavior or active planning/source-sync work, so they stay active until the current work is verified and committed. |
| Planned | To Do | Created story issues `KAN-17`, `KAN-19`, `KAN-30`, `KAN-33`, and `KAN-52`. | These are writer/content-producer implementation tasks, owner workflow follow-ups, or the future focused intake implementation, so they stay open. |
...
| PF-407 | [KAN-29](https://thouzands.atlassian.net/browse/KAN-29) | Hide or remove abusive comments | JIRA-IMPORT-003 | To Do | Parent: [KAN-4](https://thouzands.atlassian.net/browse/KAN-4). Local status: Implemented/in progress; Jira transition pending; local priority: High. |
...
| PF-412 | [KAN-56](https://thouzands.atlassian.net/browse/KAN-56) | Define user roles for privileged actions | JIRA-MANUAL-001; JIRA-STATUS-003; JIRA-DESC-005 | In Progress | Parent: [KAN-4](https://thouzands.atlassian.net/browse/KAN-4). Local status: Implemented/in progress; local priority: High; canonical role storage is `accounts.role` and Better Auth login records are stored in `logins`. |
