...
| JIRA-DESC-004 | 2026-07-03 | `KAN` | `analysis/jira/user-stories.md`, `analysis/jira/backlog.csv`, `analysis/product/auth-account-roadmap.md`, `analysis/technical/permission-gated-reactive-islands.md` | `16119ac` | Codex | Refreshed Jira issue `KAN-57` with the locale-layout account header island, nested owner create link, owner-only create page guard, and shared `requireAuthRoleOrNotFound` helper evidence. |
| JIRA-DESC-005 | 2026-07-03 | `KAN` | `analysis/jira/user-stories.md`, `analysis/jira/backlog.csv`, `analysis/product/auth-account-roadmap.md`, `analysis/technical/adr/0013-centralize-portfolio-account-fields-on-better-auth-user.md`, `analysis/technical/schema-and-migrations.md`, `analysis/technical/migration-catalog.md` | `79a61f5`, `3dfe952`, `4ee8bd9` | Codex | Refreshed Jira issue `KAN-56` with the completed `accounts`/`logins` table cleanup, legacy `auth_identities` removal, Better Auth `modelName` mapping, and preview branch migration evidence. |
| JIRA-STATUS-004 | 2026-07-03 | `KAN` | `analysis/jira/import-history.md`, `analysis/jira/backlog.csv`, `analysis/jira/user-stories.md` | Pending local sync commit | Codex | Jira-authoritative status reconciliation: transitioned `KAN-24`, `KAN-26`, `KAN-29`, `KAN-56`, and `KAN-57` to Done and refreshed their Jira descriptions with committed evidence. Local Jira records now mirror that execution state. |
| JIRA-MANUAL-003 | 2026-07-03 | `KAN` | `analysis/jira/user-stories.md`, `analysis/jira/backlog.csv`, `analysis/jira/import-history.md`, `.agents/cross-tool-sync.md` | Pending local sync commit | Codex | Manually created `PF-414` through `PF-417` as `KAN-58` through `KAN-61` under `KAN-4`, `PF-706` as `KAN-62` under `KAN-7`, and `PF-105` as `KAN-63` under `KAN-1`. Added dependency links: `KAN-58` blocks `KAN-59` and `KAN-61`, `KAN-19` relates to `KAN-60`, and `KAN-9` relates to `KAN-63`. |
| JIRA-CONF-LINKS-001 | 2026-07-03 | `KAN` | `analysis/product/scope-and-requirements.md`, `analysis/product/auth-account-roadmap.md`, `analysis/product/cms-authoring-workflow.md`, `analysis/product/media-asset-lifecycle.md`, `analysis/product/interaction-policy.md`, `analysis/product/conversion-path.md`, `analysis/product/service-offer-catalog.md`, `analysis/planning/requirements-traceability-matrix.md` | Pending local sync commit | Codex | Added interim Jira comments to open planned stories `KAN-17`, `KAN-19`, `KAN-30`, `KAN-33`, `KAN-52`, and `KAN-58` through `KAN-63`; published the Scope And Requirements Confluence page version 4 with a current Jira-backed requirement links table for native Confluence content discovery. The interim comments were superseded and removed by `JIRA-CONF-LINKS-003`. |
| JIRA-CONF-LINKS-002 | 2026-07-04 | `KAN` | `analysis/jira/import-history.md`, `analysis/product/scope-and-requirements.md`, `analysis/product/conversion-path.md`, `analysis/product/service-offer-catalog.md`, `analysis/jira/user-stories.md`, `analysis/planning/requirements-traceability-matrix.md` | Pending local sync commit | Codex | Created native Jira remote links on `KAN-62` to Confluence pages Scope And Requirements, User Stories, Requirements Traceability Matrix, Conversion Path Brief, and Service Offer Catalog using the Jira remote-link API. |
| JIRA-CONF-LINKS-003 | 2026-07-04 | `KAN` | `analysis/jira/import-history.md`, `analysis/product/scope-and-requirements.md`, `analysis/product/auth-account-roadmap.md`, `analysis/product/cms-authoring-workflow.md`, `analysis/product/media-asset-lifecycle.md`, `analysis/product/interaction-policy.md`, `analysis/product/conversion-path.md`, `analysis/product/service-offer-catalog.md`, `analysis/technical/api-surface-inventory.md`, `analysis/design/diagrams/pf-diag-003-auth-identifier-session-flow.md`, `analysis/operations/release-and-review-cadence.md` | Pending local sync commit | Codex | Replaced interim Confluence-link comments on `KAN-17`, `KAN-19`, `KAN-30`, `KAN-33`, `KAN-52`, and `KAN-58` through `KAN-61` with native Jira remote links matching the original page lists. Deleted interim comments `10074` through `10083` where present; unrelated dependency/context comments were preserved, and `KAN-63` had no remaining interim Confluence-link comment. |

## Status Mapping Decision

| Local analysis status | Jira status | Applies to | Notes |
| --- | --- | --- | --- |
| Implemented | Done | Created story issues `KAN-8` through `KAN-16`, `KAN-18`, `KAN-20` through `KAN-29`, `KAN-31`, `KAN-32`, `KAN-34` through `KAN-51`, `KAN-53` through `KAN-57`. | These stories represent completed public portfolio, backend, CMS, i18n, auth, blog, moderation, quality, operations, architecture, analysis setup, technical inventory, planning, role, permission-island, and service-definition work with implementation or documentation evidence. |
| Implemented/in progress | In Progress | No current story issues after `JIRA-STATUS-004`. | Reserved for future active local slices that have committed evidence but still need acceptance or status reconciliation. |
| Planned | To Do | Created story issues `KAN-17`, `KAN-19`, `KAN-30`, `KAN-33`, `KAN-52`, and `KAN-58` through `KAN-63`. | These are writer/content-producer implementation tasks, owner workflow follow-ups, the future focused intake implementation, email/profile/experiments slices, and design work, so they stay open. |
...
| PF-105 | [KAN-63](https://thouzands.atlassian.net/browse/KAN-63) | Render experience as a horizontal candlestick chart | JIRA-MANUAL-003 | To Do | Parent: [KAN-1](https://thouzands.atlassian.net/browse/KAN-1). Related to [KAN-9](https://thouzands.atlassian.net/browse/KAN-9). Local status: Planned; local priority: Medium. |
...
| PF-402 | [KAN-24](https://thouzands.atlassian.net/browse/KAN-24) | Sign in and sign out reliably | JIRA-IMPORT-003; JIRA-STATUS-004 | Done | Parent: [KAN-4](https://thouzands.atlassian.net/browse/KAN-4). Local status: Implemented; local priority: High. |
...
| PF-404 | [KAN-26](https://thouzands.atlassian.net/browse/KAN-26) | Comment on blog posts | JIRA-IMPORT-003; JIRA-STATUS-004 | Done | Parent: [KAN-4](https://thouzands.atlassian.net/browse/KAN-4). Local status: Implemented; local priority: High. |
...
| PF-407 | [KAN-29](https://thouzands.atlassian.net/browse/KAN-29) | Hide or remove abusive comments | JIRA-IMPORT-003; JIRA-STATUS-004 | Done | Parent: [KAN-4](https://thouzands.atlassian.net/browse/KAN-4). Local status: Implemented; local priority: High. |
...
| PF-412 | [KAN-56](https://thouzands.atlassian.net/browse/KAN-56) | Define user roles for privileged actions | JIRA-MANUAL-001; JIRA-STATUS-003; JIRA-DESC-005; JIRA-STATUS-004 | Done | Parent: [KAN-4](https://thouzands.atlassian.net/browse/KAN-4). Local status: Implemented; local priority: High; canonical role storage is `accounts.role` and Better Auth login records are stored in `logins`. |
| PF-413 | [KAN-57](https://thouzands.atlassian.net/browse/KAN-57) | Plan permission-gated reactive islands | JIRA-MANUAL-002; JIRA-DESC-004; JIRA-STATUS-004 | Done | Parent: [KAN-4](https://thouzands.atlassian.net/browse/KAN-4). Related to [KAN-56](https://thouzands.atlassian.net/browse/KAN-56). Local status: Implemented; local priority: High. |
| PF-414 | [KAN-58](https://thouzands.atlassian.net/browse/KAN-58) | Set up email sending foundation | JIRA-MANUAL-003 | To Do | Parent: [KAN-4](https://thouzands.atlassian.net/browse/KAN-4). Blocks [KAN-59](https://thouzands.atlassian.net/browse/KAN-59) and [KAN-61](https://thouzands.atlassian.net/browse/KAN-61). Local status: Planned; local priority: High. |
| PF-415 | [KAN-59](https://thouzands.atlassian.net/browse/KAN-59) | Add Better Auth email OTP and link authentication | JIRA-MANUAL-003 | To Do | Parent: [KAN-4](https://thouzands.atlassian.net/browse/KAN-4). Blocked by [KAN-58](https://thouzands.atlassian.net/browse/KAN-58). Local status: Planned; local priority: High. |
| PF-416 | [KAN-60](https://thouzands.atlassian.net/browse/KAN-60) | Add account profile pictures through managed uploads | JIRA-MANUAL-003 | To Do | Parent: [KAN-4](https://thouzands.atlassian.net/browse/KAN-4). Related to [KAN-19](https://thouzands.atlassian.net/browse/KAN-19). Local status: Planned; local priority: Medium. |
| PF-417 | [KAN-61](https://thouzands.atlassian.net/browse/KAN-61) | Add opt-in email notification preferences | JIRA-MANUAL-003 | To Do | Parent: [KAN-4](https://thouzands.atlassian.net/browse/KAN-4). Blocked by [KAN-58](https://thouzands.atlassian.net/browse/KAN-58). Local status: Planned; local priority: Medium. |
...
| PF-706 | [KAN-62](https://thouzands.atlassian.net/browse/KAN-62) | Add recruiter experiment sandbox | JIRA-MANUAL-003 | To Do | Parent: [KAN-7](https://thouzands.atlassian.net/browse/KAN-7). Local status: Planned; local priority: High. |
