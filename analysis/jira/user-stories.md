...
| PF-608 | As the portfolio owner, I want external tool setup history, so Confluence pages, Jira keys, and FigJam sections stay traceable to local source files. | Medium | Planned | Tool setup plan, Confluence publishing runbook, Jira import history, and FigJam creation log are documented. | `analysis/planning/tool-setup-plan.md`, `analysis/confluence/publishing-runbook.md`, `analysis/jira/import-history.md`, `analysis/design/figjam-creation-log.md` |
| PF-609 | As the portfolio owner, I want a review cadence, decision log, and open-question register, so product direction stays maintained after setup. | Medium | Planned | Release/review cadence, decision log, and open questions register are documented and linked from the suite. | `analysis/operations/release-and-review-cadence.md`, `analysis/operations/decision-log.md`, `analysis/operations/open-questions.md` |
