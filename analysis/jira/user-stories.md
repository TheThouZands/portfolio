...
| PF-505 | As the portfolio owner, I want source-controlled product analysis, so future work can be planned instead of improvised. | High | Planned | Analysis directory exists; requirements, stories, traceability, ADR, schema inventory, and API notes are in place. | This suite |
