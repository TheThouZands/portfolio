...
| PF-207 | As the portfolio owner, I want media lifecycle decisions before upload tooling, so assets do not become unmanaged storage clutter. | Medium | Planned | Authoring workflow and ADR 0011 defer media upload, alt text, lifecycle, cleanup, and reconciliation into a separate decision before implementation. | `analysis/product/cms-authoring-workflow.md`, ADR 0011 |
