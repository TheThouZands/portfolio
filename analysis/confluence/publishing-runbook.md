...
| Confluence Publishing Runbook | `analysis/confluence/publishing-runbook.md` | `bf2900b` | https://thouzands.atlassian.net/wiki/spaces/Portfolio/pages/2031617/Confluence+Publishing+Runbook | 2026-06-29 | Readable publishing steps and metadata rules; Git runbook remains authoritative. |
| Page Manifest | `analysis/confluence/page-manifest.csv` | `bf2900b` | https://thouzands.atlassian.net/wiki/spaces/Portfolio/pages/2064385/Page+Manifest | 2026-06-29 | Readable companion to the Git-owned CSV manifest. |
...
| Content Strategy | `analysis/product/content-strategy.md` | `695e4d8` | https://thouzands.atlassian.net/wiki/spaces/Portfolio/pages/1376284/Content+Strategy | 2026-06-29 | Content pillars and publication workflow. |
