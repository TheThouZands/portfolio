...
| Jira Backlog | `analysis/jira/import-history.md` | `a9cdad4` | https://thouzands.atlassian.net/wiki/spaces/Portfolio/pages/720897/Jira+Backlog | 2026-06-29 | Starter container page; Jira epics `KAN-1` through `KAN-7` and stories `KAN-8` through `KAN-55` are mapped, with 40 implemented stories marked `Done`, `KAN-24` and `KAN-26` marked `In Progress`, and `KAN-17`, `KAN-19`, `KAN-29`, `KAN-30`, `KAN-33`, and `KAN-52` left `To Do`. |
