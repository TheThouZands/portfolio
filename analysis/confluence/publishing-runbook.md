...
| Schema And Migrations | `analysis/technical/schema-and-migrations.md` | Current local sync | https://thouzands.atlassian.net/wiki/spaces/Portfolio/pages/1310758/Schema+And+Migrations | 2026-07-02 | Auth placeholder-email migration guard synced to Confluence v2; Git source remains authoritative. |
| Schema Table Catalog | `analysis/technical/schema-table-catalog.md` | Current local sync | https://thouzands.atlassian.net/wiki/spaces/Portfolio/pages/1212448/Schema+Table+Catalog | 2026-07-02 | Auth login and verification table semantics synced to Confluence v2; Git source remains authoritative. |
