...
| Jira Backlog | `analysis/jira/import-history.md` | `80a2d1d` | https://thouzands.atlassian.net/wiki/spaces/Portfolio/pages/720897/Jira+Backlog | 2026-06-29 | Starter container page; Jira epics `KAN-1` through `KAN-7` and stories `KAN-8` through `KAN-33` are mapped, with implemented created stories marked `Done`, current-worktree stories marked `In Progress`, and planned created stories left `To Do`. |
