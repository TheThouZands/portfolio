...
| Jira Backlog | `analysis/jira/import-history.md` | `ca99f14` | https://thouzands.atlassian.net/wiki/spaces/Portfolio/pages/720897/Jira+Backlog | 2026-06-29 | Starter container page; Jira epics `KAN-1` through `KAN-7` and stories `KAN-8` through `KAN-19` are now mapped. |
