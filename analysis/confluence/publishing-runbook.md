...
| User Stories | `analysis/jira/user-stories.md` | Current local sync | https://thouzands.atlassian.net/wiki/spaces/Portfolio/pages/1802241/User+Stories | 2026-07-03 | Epic and story narrative with acceptance criteria, evidence, and `PF-412` / `KAN-56` `accounts`/`logins` cleanup evidence. |
...
| Import History | `analysis/jira/import-history.md` | `a9cdad4` | https://thouzands.atlassian.net/wiki/spaces/Portfolio/pages/1835009/Import+History | 2026-06-29 | Local id to Jira key mapping, import run log, status mapping decision, and `JIRA-STATUS-002`. Local source now includes `JIRA-DESC-005`; operations-page refresh is pending. |
