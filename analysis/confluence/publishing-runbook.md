...
| Jira Backlog | `analysis/jira/import-history.md` | Current local sync | https://thouzands.atlassian.net/wiki/spaces/Portfolio/pages/720897/Jira+Backlog | 2026-07-02 | Starter container page; Jira epics `KAN-1` through `KAN-7` and stories `KAN-8` through `KAN-57` are mapped, with 40 implemented stories marked `Done`, `KAN-24`, `KAN-26`, `KAN-56`, and `KAN-57` marked `In Progress`, and `KAN-17`, `KAN-19`, `KAN-29`, `KAN-30`, `KAN-33`, and `KAN-52` left `To Do`. |
...
| Schema And Migrations | `analysis/technical/schema-and-migrations.md` | Current local sync | https://thouzands.atlassian.net/wiki/spaces/Portfolio/pages/1310758/Schema+And+Migrations | 2026-07-02 | `0021_violet_arclight.sql` account role/username foundation synced to Confluence v3; Git source remains authoritative. |
| Schema Table Catalog | `analysis/technical/schema-table-catalog.md` | Current local sync | https://thouzands.atlassian.net/wiki/spaces/Portfolio/pages/1212448/Schema+Table+Catalog | 2026-07-02 | `auth_role` and `user` account fields synced to Confluence v3; Git source remains authoritative. |
| Migration Catalog | `analysis/technical/migration-catalog.md` | Current local sync | https://thouzands.atlassian.net/wiki/spaces/Portfolio/pages/1245186/Migration+Catalog | 2026-07-02 | `0021_violet_arclight.sql` account role/username foundation synced to Confluence v2; Git source remains authoritative. |
...
| Scope And Requirements | `analysis/product/scope-and-requirements.md` | `a9cdad4` | https://thouzands.atlassian.net/wiki/spaces/Portfolio/pages/1343502/Scope+And+Requirements | 2026-06-29 | Requirement ids must stay stable; planning/tooling baselines reconciled. |
| Auth And Account Roadmap | `analysis/product/auth-account-roadmap.md` | Current local sync | https://thouzands.atlassian.net/wiki/spaces/Portfolio/pages/2097154/Auth+And+Account+Roadmap | 2026-07-02 | Reader, Moderator, Owner, client, protected workflow, permission-gated island strategy, island-versus-route-gate boundary, and email verification semantics synced to Confluence v7. |
...
| Requirements Traceability Matrix | `analysis/planning/requirements-traceability-matrix.md` | `a9cdad4` | https://thouzands.atlassian.net/wiki/spaces/Portfolio/pages/786449/Requirements+Traceability+Matrix | 2026-06-29 | FR/NFR to persona, story, evidence, and verification map. |
...
| User Stories | `analysis/jira/user-stories.md` | `a9cdad4` | https://thouzands.atlassian.net/wiki/spaces/Portfolio/pages/1802241/User+Stories | 2026-06-29 | Epic and story narrative with acceptance criteria, evidence, and reconciled Jira status mapping. |
...
| 2026-07-02 | `analysis/technical/permission-gated-reactive-islands.md`; `analysis/product/auth-account-roadmap.md`; `analysis/jira/user-stories.md`; `analysis/jira/backlog.csv` | Matching Confluence pages in `analysis/confluence/page-manifest.csv` and Jira issue `KAN-57` | Local permission-island hook and current-role tester implementation is not committed yet; refresh Confluence/Jira from the committed source hash after this slice is accepted. |
...
| 2026-07-03 | `analysis/technical/permission-gated-reactive-islands.md`; `analysis/product/auth-account-roadmap.md`; `analysis/jira/user-stories.md`; `analysis/jira/backlog.csv`; `analysis/jira/import-history.md` | Matching Confluence pages in `analysis/confluence/page-manifest.csv` and Jira issue `KAN-57` | Local persistent header account island and nested owner create proof needs external Confluence/Jira refresh after the source commit is accepted. |
