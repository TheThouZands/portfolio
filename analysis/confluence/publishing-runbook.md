...
| Jira Backlog | `analysis/confluence/page-manifest.csv` | `dd6c8a4` | https://thouzands.atlassian.net/wiki/spaces/Portfolio/pages/720897/Jira+Backlog | 2026-06-29 | Starter container page; Jira project `KAN` is now visible. |
