...
| Batch 2 | Jira project `KAN`, epics, CSV import, key mapping. | Epic keys and the first `PF-E01` story keys are mapped; remaining local story ids still need Jira issue keys. |
