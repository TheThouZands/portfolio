...
| --- | --- | --- | --- | --- |
| EXT-001 | Confluence | Create or use the Portfolio space, root page, and first page tree from `page-manifest.csv`. | Root, starter container pages, priority 1 product content pages, priority 1 planning pages, priority 1 Jira pages, priority 1 design pages, and priority 1 technical pages exist with source metadata; remaining priority 1 operations pages can follow in smaller batches. | `analysis/confluence/page-manifest.csv`, `analysis/confluence/publishing-runbook.md` |
...
- Source-ready priority 1 diagram pages exist: `Blog Comment Flow` and `Deployment And Neon Branch Workflow`; their FigJam generation remains pending.
...
- Remaining priority 1 operations pages from `analysis/confluence/page-manifest.csv` remain the next Confluence batch.
