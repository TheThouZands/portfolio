...
| --- | --- | --- | --- | --- |
| EXT-001 | Confluence | Create or use the Portfolio space, root page, and first page tree from `page-manifest.csv`. | Root, starter container pages, priority 1 product content pages, priority 1 planning pages, priority 1 Jira pages, priority 1 design overview pages, generated priority 1 diagram pages, and source-ready priority 1 diagram pages exist with source metadata; remaining priority 1 technical and operations pages can follow in smaller batches. | `analysis/confluence/page-manifest.csv`, `analysis/confluence/publishing-runbook.md` |
...
- Remaining priority 1 technical and operations pages from `analysis/confluence/page-manifest.csv` remain the next Confluence batches.
