...
| --- | --- | --- | --- | --- |
| EXT-001 | Confluence | Create or use the Portfolio space, root page, and first page tree from `page-manifest.csv`. | Root, starter container pages, priority 1 product content pages, and priority 1 planning pages exist with source metadata; remaining priority 1 Jira, design, technical, and operations pages can follow in smaller batches. | `analysis/confluence/page-manifest.csv`, `analysis/confluence/publishing-runbook.md` |
...
- Remaining priority 1 Jira, design, technical, and operations pages from `analysis/confluence/page-manifest.csv` remain the next Confluence batches.
