...
| Stale Confluence page sync | Pending | Sync Tool Setup Plan, External Setup Execution Runbook, Readiness Audit, Traceability, Confluence Publishing Runbook, Page Manifest, and any source pages changed by the cleanup slice. |
...
| FigJam documentation-toolchain refresh | Pending | Replace live FigJam wording that still implies implementation feeds analysis. |
...
| Final handoff check pass | Pending | Re-run manifest counts, stale wording scans, Jira status JQL, Confluence spot checks, and FigJam spot check after sync. |
